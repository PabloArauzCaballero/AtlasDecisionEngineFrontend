...
| Runtime UI | React | 19.1.0 | Ya utilizado por el proyecto y compatible con Next seleccionado | Ajustar a una versión soportada por Next mediante ADR |
...
- React Router se mantiene temporalmente solo para la aplicación Vite heredada y será retirado cuando las 25 rutas estén migradas.
