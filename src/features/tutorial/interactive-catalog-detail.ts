    ...
    steps: [
      {
        ...
        content:
          'Aquí se dibuja, como un diagrama, el camino que sigue una decisión: entran datos, se evalúan condiciones y se llega a un resultado (aprobado, rechazado o a revisión).',
      },
      {
        id: 'load',
        target: '[data-tutorial-id="graph-load"]',
        title: '1 · Cargar una versión',
        content:
          'Todo empieza eligiendo qué versión vas a diseñar. Sólo se puede editar una versión en BORRADOR: las aprobadas quedan congeladas para que su historia sea auditable.',
        optional: true,
      },
      {
        id: 'inputs',
        target: '.input-contract-panel',
        title: '2 · Declara las ENTRADAS',
        content:
          'Las entradas son los datos que la decisión necesita recibir. Hasta que declares alguna, los selectores de condiciones estarán vacíos: no hay nada sobre lo que decidir.',
      ...
      },
      {
        ...
        title: '3 · Declara las SALIDAS',
        content:
          'Las salidas son lo que la decisión DEVUELVE. Una de ellas es la principal (la estrella): el desenlace que resume la decisión. Sin salidas, el algoritmo no devolvería nada.',
        optional: true,
      },
      {
        id: 'library',
        target: '.node-library',
        title: '4 · Arrastra bloques al lienzo',
        content:
          'Cada bloque hace una cosa: CONDICIÓN bifurca según una regla, SCORE calcula un puntaje, RESULTADO cierra el camino con un desenlace. Arrástralo al punto del lienzo donde lo quieras.',
        optional: true,
      },
      {
        id: 'canvas',
        target: '.graph-canvas',
        title: '5 · Recorre el lienzo',
        content:
          'El lienzo es más grande que la pantalla: usa las barras de desplazamiento (o el zoom de la barra superior) para recorrer el flujo. Arrastra un bloque para moverlo y haz clic para editar sus propiedades.',
        tip: '“Auto-organizar” recoloca todo el grafo como un árbol de izquierda a derecha.',
        optional: true,
      },
      {
        id: 'connect',
        target: '[data-tutorial-id="graph-connect"]',
        title: '6 · Conecta las rutas',
        content:
      ...
      {
        id: 'checklist',
        target: '.flow-checklist',
        title: '7 · Revisa el flujo',
        content:
          'Esta lista avisa de lo que impediría publicar: bloques sin salida, caminos que no llegan a un final o condiciones sin definir. Haz clic en un aviso para saltar al bloque que lo causa.',
        optional: true,
      },
      {
        id: 'notes',
        target: '.graph-notes',
        title: '8 · Documenta el porqué',
        content:
          'Las notas explican, en palabras, por qué existe cada rama y qué supone la decisión. Es lo que agradecerá quien revise o herede esta política.',
        optional: true,
      },
      {
        id: 'validate',
        target: '[data-tutorial-id="graph-validate"]',
        title: '9 · Valida y guarda',
        content:
          'Validar comprueba la estructura y las expresiones del grafo completo; guardar escribe la versión borrador. Sólo un grafo válido puede compilarse, probarse y desplegarse.',
        optional: true,
      },
    ],
  },
